...
/**
 * @title Miracle
 * @dev This on-chain Video NFT is dedicated
 *      to my girlfriend who just had a car
 *      accident and thanks to two people in
 *      heaven it seems shes okay.
 */
contract Miracle is ERC721, Ownable {
    constructor() Ownable(InitialOwner) ERC721("Miracle", "CLEM") {}

    address InitialOwner = 0x6E5163fC4BFc1511Dbe06bB605cc14a3e462332b;
    string public hijess = "SE TE NE VAI IO COME FACCIO SENZA DI TE";
    string public video = "";
    bool public locked = false;

    /**
     * @dev Sets the NFT video.
     * @param _video The video, in Kirsh format, encoded in base64.
    */
    function setVideo(
